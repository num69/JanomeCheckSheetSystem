            ...
            html += 
                "<tr>"
                    ...
                    + "<td class=\"text-center\">"
                        + "<button type=\"button\" class=\"btn btn-sm btn-outline-secondary user-action-btn js-edit-user mr-1\" data-user-id=\"" + escapeHtml(row.UserId) + "\" title=\"แก้ไข\">"
                            + "<i class=\"fas fa-edit\"></i>"
                        + "</button>"
                        + "<button type=\"button\" class=\"btn btn-sm btn-outline-danger user-action-btn js-delete-user\" data-user-id=\"" + escapeHtml(row.UserId) + "\" title=\"ลบ\">"
